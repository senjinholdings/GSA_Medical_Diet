                ...
                <div class=\"columns-container\"> 
                            ...
                            <div class=\"tips-merits-container\"> 
                                <div class=\"tips-merits-card\"> 
                                    ...
                                    <ul class=\"merits-list\"> 
                                        ...
                                        <li>医師による診察・管理のもとで安全に信頼のある状態で施術が行われる</li> 
                                        <li>短期間で結果が出やすい</li> 
                                    </ul> 
                                </div> 
                                <div class=\"tips-merits-card\"> 
                    ...
                    <div class=\"article-card\"> 
                        <div class=\"highlight-box\" id=\"contract\"> 
                            ...
                            <div class=\"content-section\" id=\"insurance\"> 
                                ...
                                <div class=\"section-content\"> 
                                    医療痩身の主な目的は美容目的であることが多いため、保険が適用されない自由診療に分類されます。<span style=\"background-color: #fff3cd; padding: 2px 4px;\">全額自費負担</span>となる点を理解し、契約前に総額や後出しの追加費用を必ず確認しましょう。 
                                </div> 
                            </div> 
                        </div> 
                    </div> 
                    ...
                    <div class=\"article-card\"> 
                        <div class=\"highlight-box\" id=\"additional-fees\"> 
                            ...
                            <div class=\"section-content\"> 
                                特に麻酔代はクリニックにより異なります。後出しの追加費用については、契約前に必ず確認するようにしてください。 
                            </div> 
                        </div> 
                    </div> 
