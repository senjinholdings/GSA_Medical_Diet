...
class DataManager {
        ...
        try {
            ...
            try {
                ...
                if (clinicTextResponse.ok) {
                    ...
                    console.log('✅ クリニック別テキストデータを読み込みました:', Object.keys(this.clinicTexts));
                } else {
    ...
    getClinicText(clinicCode, itemKey, defaultText = '') {
        // coolsculptingのclinic-texts.jsonはクリニックコードがキーとなっている
        if (clinicCode && this.clinicTexts && this.clinicTexts[clinicCode] && this.clinicTexts[clinicCode][itemKey]) {
            return this.clinicTexts[clinicCode][itemKey];
        }
        return defaultText;
    }
